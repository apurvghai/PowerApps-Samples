...
namespace Microsoft.Support.Dataverse.Samples.BulkDataImporter
{
    public class BulkImporter
    {
            ...
            FunctionContext executionContext)
        {
            ...
            string applicationUserId = queryParameters["applicationUserId"];
            string appUserId = applicationUserId ?? throw new ArgumentNullException($"Application User Id Is Missing");

            string applicationUserIdKey = queryParameters["applicationUserIdKey"];
            string appUserIdKey = applicationUserIdKey ?? throw new ArgumentNullException($"Application User Key Is Missing");
            ...
            _logger.LogInformation($"Application User :{applicationUserId}");

            await dataverseBulkImporter.ExecuteAsync(
                logger: _logger,
                applicationUserId: applicationUserId,
                applicationUserSecretKey: applicationUserIdKey,
