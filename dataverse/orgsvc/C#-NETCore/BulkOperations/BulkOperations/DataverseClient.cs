...
namespace Microsoft.Support.Dataverse.Samples.BulkDataImporter
{
    public class DataverseClient
    {
        ...
        public async Task<ServiceClient> GetClientAsync(ILogger logger, string applicationUserId, string applicationUserSecretKey)
        {
            ApplicationUser applicationUser = await this.applicationUsers.GetUserAsync(applicationUserId, applicationUserSecretKey);
