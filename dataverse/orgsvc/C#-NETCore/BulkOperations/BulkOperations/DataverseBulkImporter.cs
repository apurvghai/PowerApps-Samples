...
namespace Microsoft.Support.Dataverse.Samples.BulkDataImporter
{
    ...
    public class DataverseBulkImporter
    {
        ...
        /// <param entityName="applicationUserId">Specify the the Application User ID</param>
        /// <param entityName="applicationUserSecretKey">Specify the User Index to Pick The Application User (KeyVault) Key Name</param>
        ...
        public async Task ExecuteAsync(
            ...
            string applicationUserSecretKey,
            bool isElasticTable,
            int recordsToInsert,
            int batchSize,
            int dop,
            ...
            int maxRetryCount)
        {
            try
            {
                ...
                using (ServiceClient client = await dataverseClient.GetClientAsync(logger, applicationUserId, applicationUserSecretKey))
                {
