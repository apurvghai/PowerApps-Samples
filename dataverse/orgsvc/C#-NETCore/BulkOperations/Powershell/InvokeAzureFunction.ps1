...
1..100 | ForEach-Object -ThrottleLimit 16 -Parallel {
	...
	$baseUrl = "https://<your-az-func>.azurewebsites.net/api/AzFuncBulkOperationOrchestrator?code=&records=100000&dop=50&batch=100&applicationUserId=<YourGuid>&applicationUserSecretKey=<YourKVSecretKeyName>&correlationId=24bd4ffa-9069-43c9-a863-83a4301be3f4";
